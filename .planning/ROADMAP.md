...
- [x] 06-04-PLAN.md — PlannerCalendar (hand-rolled 7-column grid, month nav, has-data dots), date navigation (prev/next/today/month-view) in PlannerPanel
- [x] 06-05-PLAN.md — Integration: "+ Plan" in PinListItem, "Add to Plan" in MarkerLayer InfoWindow, "Send to Planner" in RouteConfirmPanel, "Route It" in PlannerPanel
**UI hint**: yes
